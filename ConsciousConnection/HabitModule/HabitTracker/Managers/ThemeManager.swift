...
enum AccentColor: String, CaseIterable, Identifiable {
    ...
    var rgbComponents: (r: Double, g: Double, b: Double) {
        switch self {
        case .purple: return (0.66, 0.33, 0.97)
        case .pink: return (0.93, 0.29, 0.60)
        case .blue: return (0.23, 0.51, 0.96)
        case .green: return (0.06, 0.73, 0.51)
        case .orange: return (0.96, 0.62, 0.04)
        case .red: return (0.94, 0.27, 0.27)
        case .cyan: return (0.02, 0.71, 0.83)
        case .indigo: return (0.39, 0.40, 0.95)
        }
    }
}
